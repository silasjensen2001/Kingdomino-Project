...
while True:
    frame = cv2.imread('King Domino dataset\Cropped and perspective corrected boards\\61.jpg') #hvis du vil se konceptet med et billede
    #frame = cv2.imread('King Domino dataset\TestSet\\Img8.jpg') #hvis du vil se konceptet med et billede
